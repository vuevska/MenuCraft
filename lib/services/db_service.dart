...
// import '../models/items_category_model.dart';
...
//   Future<ItemsCategoryModel?> getCategory(String categoryId) async {
//     try {
//       DocumentSnapshot categories =
//           await _db.collection('restaurant_categories').doc(categoryId).get();
//       if (categories.exists) {
//         return ItemsCategoryModel.fromMap(
//             categories.data()! as Map<String, dynamic>);
//       } else {
...
//   Future<List<ItemsCategoryModel>> getAllCategories() async {
//     try {
//       QuerySnapshot categorySnapshot =
//           await _db.collection('restaurant_categories').get();

//       List<ItemsCategoryModel> categories = categorySnapshot.docs
//           .map((doc) =>
//               ItemsCategoryModel.fromMap(doc.data() as Map<String, dynamic>))
//           .toList();
//       return categories;
//     } catch (error) {
